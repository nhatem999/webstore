...
<html lang="en">
    <head>
        ...
        <!-- Bootstrap core CSS -->
        <link href="http://localhost/unitop/back-end/project/ismart.com.vn/ismart.com/vnpay_php/assets/bootstrap.min.css" rel="stylesheet"/>
        <!-- Custom styles for this template -->
        <link href="http://localhost/unitop/back-end/project/ismart.com.vn/ismart.com/vnpay_php/assets/jumbotron-narrow.css" rel="stylesheet">  
    ...
    <body>
        ...
        <div class="container">
            ...
            <div class="table-responsive">
                <form action="http://localhost/unitop/back-end/project/ismart.com.vn/ismart.com/vnpay_php/vnpay_create_payment.php" id="create_form" method="post">       
